...
?>
			...
			$status=$row['status'];	
			 ...
			 echo "<td>
				<input type='checkbox' class='flat-red' value='$questionID' id='quesID' name='quesID[]' ";
					...
					$myArray = explode(',', $quesSetList);
					foreach($myArray as $my_Array)
					{
						if($questionID==$my_Array)
						{
		...
		<div class="box-footer" align="middle">
			<input type='submit' id="submit" name='submit' class="btn btn-primary" value='Create Question Paper'>
		</div>	
